...
const friendsData = [
  { id: 1, name: 'Paras Mani',     role: 'UI UX Design Lead',    image: '/frnd1.png', socialPlatform: 'Instagram', socialLink: '#', delay: 0.1 },
  { id: 2, name: 'Atul Dogra',     role: 'Sr. UI UX Designer',   image: '/frnd2.png', socialPlatform: 'LinkedIn',  socialLink: '#', delay: 0.2 },
  { id: 3, name: 'Pramod Kumar',   role: 'Sr. UI UX Designer',   image: '/frnd3.png', socialPlatform: 'LinkedIn',  socialLink: '#', delay: 0.3 },
  { id: 4, name: 'Rajat Thakur',   role: 'Sr. UI UX Designer',   image: '/frnd4.png', socialPlatform: 'LinkedIn',  socialLink: '#', delay: 0.4 },
  { id: 5, name: 'P. V. Dinesh',   role: 'Product Owner',         image: '/frnd5.png', socialPlatform: 'LinkedIn',  socialLink: '#', delay: 0.5 },
  { id: 6, name: 'Prabhu Yadav',   role: 'Product Manager',       image: '/frnd6.png', socialPlatform: 'LinkedIn',  socialLink: '#', delay: 0.6 },
  { id: 7, name: 'Mridul Sachdeva',role: 'Product Manager',       image: '/frnd7.png', socialPlatform: 'LinkedIn',  socialLink: '#', delay: 0.7, isCenter: true },
];
...
export default function AboutClient() {
  ...
  return (
    <main className="min-h-screen bg-[#121212] text-white">
        ...
        {journeyData.map((item) => (
          ...
          >
            ...
            <motion.div variants={itemVariants} className="lg:w-1/2 space-y-6">
              ...
              <h2 className="text-lg sm:text-xl font-heading font-bold text-neutral-100 mb-4">
                {item.title}
              </h2>
      ...
      {/* View Projects CTA */}
      <section className="max-w-6xl mx-auto px-4 md:px-12 py-16 text-center">
        <p className="text-xs text-neutral-500 uppercase tracking-widest mb-3">See the work</p>
        <h2 className="text-3xl font-heading font-bold text-white mb-4">Want to see what I&apos;ve built?</h2>
        <p className="text-neutral-400 mb-8 max-w-xl mx-auto">Explore 7 detailed case studies covering education, healthcare, music, and energy — from research to shipped product.</p>
        <a
          href="/projects"
          className="inline-flex items-center gap-2 px-8 py-4 bg-white text-black font-semibold rounded-lg hover:bg-neutral-200 transition-colors duration-200"
        >
          View All Projects
